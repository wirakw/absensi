      ...
      <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
          <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item ml-5 font-weight-bold mr-3">
              <a class="nav-link text-white" href="https://stagingstagingpembayaran.dompetaman.com/">Marketplace</a>
            </li>
                ...
                $.ajax({
                    ...
                    success: function(data){
                        if (data.success == true) {
                            ...
                            setTimeout(function() {
                            window.location.href = 'https://staging-merchant.dompetaman.com/Login';
                            }, 2000);
